...
const createRow = (i) => {
    ...
    createTd(library[i].author, object, "font-weight:900;text-align:center;font-size:1.2em;");
    createTd(library[i].title, object, "text-align:center;font-size:1.2em;");
    createTd(library[i].pages.toString(), object, "text-align:center;font-size:1.2em;");
...
const deleteButton = (parent) => {
    ...
    button.addEventListener("click", function () {
        var _a;
        let parentElement = (_a = this.parentElement) === null || _a === void 0 ? void 0 : _a.parentElement;
